...
class Dashboard {
	...
	public function get_admin_menu() {
		...
		$menu[] = array(
			'title'         => esc_html__( 'Rate Us', 'jeg-elementor-kit' ) . '<span>★★★★★</span>',
			'menu'          => esc_html__( 'Rate Us', 'jeg-elementor-kit' ) . '<span>★★★★★</span>',
			'slug'          => 'rate-us',
			'priority'      => 64,
			'icon'          => '',
			'external_link' => 'https://wordpress.org/support/plugin/jeg-elementor-kit/reviews/#new-post',
			'class'         => 'jkit-review-menu',
		);
